...
INSERT INTO Leilao(nome,descricao,precoInicial,precoCompraImediata,dataDePublicacao,dataLimite)
VALUES('leilao1','leilao teste nr 1', '99.99','100','2004-10-19 10:23:54','2005-10-19 10:23:54'); -- completar data


INSERT INTO Leilao(nome,descricao,precoInicial,precoCompraImediata,dataDePublicacao,dataLimite)
VALUES('leilao2','leilao teste nr 2', '99.92','102','2004-10-19 19:23:54','2005-10-19 20:23:54'); 

INSERT INTO Leilao(nome,descricao,precoInicial,precoCompraImediata,dataDePublicacao,dataLimite)
VALUES('leilao3','leilao teste nr 3', '99.00','101','2002-10-19 10:23:54','2004-10-19 10:23:54'); 


INSERT INTO Leilao(nome,descricao,precoInicial,precoCompraImediata,dataDePublicacao,dataLimite)
VALUES('leilao4','leilao teste nr 4', '99.22','1003','2002-10-19 10:20:54','2004-10-19 10:20:54'); 


INSERT INTO Leilao(nome,descricao,precoInicial,precoCompraImediata,dataDePublicacao,dataLimite)
VALUES('leilao2','leilao teste nr 2', '99.11','1099','2002-10-19 10:23:59','2004-10-19 10:23:59'); 
...
VALUES('username1','ashe1','primeiroNome1','UltimoNome2','M','descricao1','user1@user.com',912223344,'12/03/1954','12/03/2015','imagesRecebidas/teste.png','imagesRecebidas/teste.png');

INSERT INTO Utilizador(utilizador,palavrapasse,nomeProprio,sobrenome,genero, descricao,email,telefone,dataNascimento,dataRegisto,idImagemPerfil,idImagemCapa)
VALUES('username0','ashe2','primeiroNome4','UltimoNome3','M','descricao2','user2@user.com',912221344,'12/04/1975','12/03/2015','imagesRecebidas/teste.png','imagesRecebidas/teste.png');


INSERT INTO Utilizador(utilizador,palavrapasse,nomeProprio,sobrenome,genero, descricao,email,telefone,dataNascimento,dataRegisto,idImagemPerfil,idImagemCapa)
VALUES('username2','ashe3','primeiroNome3','UltimoNome4','F','descricao3','user3@user.com',912312344,'12/04/1920','12/03/2014','imagesRecebidas/teste3.png','imagesRecebidas/teste3.png');
...
INSERT INTO Mensagem(idEmissor,idReceptor,assunto,texto,data)
VALUES(3,4,'assunto importante 3','texto3','12/03/2015');
...
INSERT INTO Admistrador(idUtilizador)
VALUES(1);
...
INSERT INTO BloqueioComentario(idComentario)
VALUES(1);


-- Utilizador Normal

INSERT INTO UtilizadorNormal(idUtilizador)
VALUES(2);
...
INSERT INTO AvaliacaoUtilizador(idAvaliador,idAvaliado,estrelas,data)
VALUES(3,4,3,'16/03/2015');


INSERT INTO AvaliacaoUtilizador(idAvaliador,idAvaliado,estrelas,data)
VALUES(4,3,3,'17/03/2015');
...
INSERT INTO AvaliacaoComentario(idAvaliador,idComentario,gosto,data)
VALUES(4,2,0,'15/03/2015');

INSERT INTO AvaliacaoComentario(idAvaliador,idComentario,gosto,data)
VALUES(4,1,0,'16/03/2015');