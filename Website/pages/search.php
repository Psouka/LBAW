<?php
    ...
    if (isset($_GET['text']) || isset($_GET['category']))
    {
        ...
        if (isset($_GET['sort']))
        {
            if ($_GET['sort'] == "pricel") usort($auctions, "sortPriceLow");
            else
            if ($_GET['sort'] == "priceh") usort($auctions, "sortPriceHigh");
            else
            if ($_GET['sort'] == "times") usort($auctions, "timeSoon");
            else
            if ($_GET['sort'] == "timen") usort($auctions, "timeNewer");
        }
        ...
        if (isset($_GET['text']) && $_GET['text'] != "") $users = searchUsers($searchfield);
