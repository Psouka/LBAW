  ...
  <div class="col-md-3">
    ...
    <div class="panel panel-default">
     <div class="panel-body">
      ...
      <form class="input-group" action="{$BASE_URL}pages/create-message.php" method="get">
        <input name="idUtilizador" type="number" value="{$profile.idutilizador}" hidden>
...
<div class="col-sm-4 col-lg-4 col-md-4">
  <div class="thumbnail">
    <img src="{$BASE_URL}{$leilao.localizacao}" alt="">
    <div class="caption">
      <h4 class="pull-right">
