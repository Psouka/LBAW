...
<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionOne" href="#collapseCategories">Categories:</a> <span class="caret"></span>
</h4>
                    </div>
                    <div class="panel-collapse collapse in" id="collapseCategories">
                        <div class="list-group">
                            {foreach $categories as $category} {if $category.idcategoria == $auction.idcategoria}
                            <a href="#" class="list-group-item active">{$category.tipo}</a> {else}
                            <a href="#" class="list-group-item">{$category.tipo}</a> {/if} {/foreach}
                        </div>
                    </div>
                </div>
            </div>
...
<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordionTwo" href="#collapseTwo">Bidders</a> <span class="caret"></span>
                    ...
                    <div class="panel-collapse collapse in" id="collapseTwo">
                        <div class="list-group">
                            {if count($bidders) == 0}
                            <a href="#" class="list-group-item">No bidders</a> {else} {foreach $bidders as $bidder}
                            <a href="#" class="list-group-item"><span class="badge">{$bidder.preco}€</span> {$bidder.nomeproprio}</a> {/foreach} {/if}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="thumbnailCarousel">
                ...
                <div class="ratings">
                    ...
                    <p>
                        ...
                        <span class="glyphicon glyphicon-star"></span> {/for} {for $index = 1 to 5 - $auction.rating}
                        <span class="glyphicon glyphicon-star-empty"></span> {/for} {$auction.rating} stars
                    </p>
                </div>
            </div>
