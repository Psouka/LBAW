  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p></p><br> Please contact <a mailto:href="lbaw1443@fe.up.pt"></a><i>lbaw1443@fe.up.pt</i></a> for any other inquiries.</p>
        </div>
        ...
        <div class="tab-pane fade" id="signup">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input id="Email" name="Email" class="form-control" type="text" placeholder="Username@domain.com" class="input-large" required="">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <label class="radio inline" style="padding-left: 20px;" for="humancheck-0">
                  <input type="radio" name="humancheck" id="humancheck-0" value="robot" checked="checked">I'm a Robot</label>
                <label class="radio inline" style="padding-left: 20px;" for="humancheck-1">
